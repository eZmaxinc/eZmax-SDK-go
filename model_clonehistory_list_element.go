...
type ClonehistoryListElement struct {
	...
	SUserLoginnameCloning string `json:"sUserLoginnameCloning" validate:"regexp=^(?:([\\w.%+\\-!#$%&'*+/=?^\x60{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2\\,20})|([a-zA-Z0-9]){1\\,32})$"`
	// The first name of the user
	SUserFirstnameCloning string `json:"sUserFirstnameCloning"`
	// The last name of the user
	SUserLastnameCloning string `json:"sUserLastnameCloning"`
	// The login name of the User.
	SUserLoginnameCloned string `json:"sUserLoginnameCloned" validate:"regexp=^(?:([\\w.%+\\-!#$%&'*+/=?^\x60{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2\\,20})|([a-zA-Z0-9]){1\\,32})$"`
	// The first name of the user
