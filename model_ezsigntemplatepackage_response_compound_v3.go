...
// checks if the EzsigntemplatepackageResponseCompoundV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplatepackageResponseCompoundV3{}

// EzsigntemplatepackageResponseCompoundV3 A Ezsigntemplatepackage Object
type EzsigntemplatepackageResponseCompoundV3 struct {
	...
	AObjEzsigntemplatepackagesigner []EzsigntemplatepackagesignerResponseCompoundV3 `json:"a_objEzsigntemplatepackagesigner"`
	AObjEzsigntemplatepackagemembership []EzsigntemplatepackagemembershipResponseCompoundV3 `json:"a_objEzsigntemplatepackagemembership"`
}

type _EzsigntemplatepackageResponseCompoundV3 EzsigntemplatepackageResponseCompoundV3
...
func NewEzsigntemplatepackageResponseCompoundV3(pkiEzsigntemplatepackageID int32, fkiEzsignfoldertypeID int32, fkiLanguageID int32, sLanguageNameX string, sEzsigntemplatepackageDescription string, bEzsigntemplatepackageAdminonly bool, bEzsigntemplatepackageNeedvalidation bool, bEzsigntemplatepackageIsactive bool, sEzsignfoldertypeNameX string, bEzsigntemplatepackageEditallowed bool, aObjEzsigntemplatepackagesigner []EzsigntemplatepackagesignerResponseCompoundV3, aObjEzsigntemplatepackagemembership []EzsigntemplatepackagemembershipResponseCompoundV3) *EzsigntemplatepackageResponseCompoundV3 {
	this := EzsigntemplatepackageResponseCompoundV3{}
...
func (o EzsigntemplatepackageResponseCompoundV3) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplatepackageResponseCompoundV3) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplatepackageResponseCompoundV3) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepackageResponseCompoundV3 := _EzsigntemplatepackageResponseCompoundV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepackageResponseCompoundV3)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepackageResponseCompoundV3(varEzsigntemplatepackageResponseCompoundV3)

	return err
}

type NullableEzsigntemplatepackageResponseCompoundV3 struct {
	value *EzsigntemplatepackageResponseCompoundV3
	isSet bool
}

func (v NullableEzsigntemplatepackageResponseCompoundV3) Get() *EzsigntemplatepackageResponseCompoundV3 {
	return v.value
}

func (v *NullableEzsigntemplatepackageResponseCompoundV3) Set(val *EzsigntemplatepackageResponseCompoundV3) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplatepackageResponseCompoundV3) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplatepackageResponseCompoundV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplatepackageResponseCompoundV3(val *EzsigntemplatepackageResponseCompoundV3) *NullableEzsigntemplatepackageResponseCompoundV3 {
	return &NullableEzsigntemplatepackageResponseCompoundV3{value: val, isSet: true}
}

func (v NullableEzsigntemplatepackageResponseCompoundV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplatepackageResponseCompoundV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
