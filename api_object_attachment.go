...
func (r ApiAttachmentDownloadV1Request) Execute() (*AttachmentDownloadV1Response, *http.Response, error) {
...
func (a *ObjectAttachmentAPIService) AttachmentDownloadV1Execute(r ApiAttachmentDownloadV1Request) (*AttachmentDownloadV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AttachmentDownloadV1Response
	)
