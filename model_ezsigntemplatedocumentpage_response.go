...
type _EzsigntemplatedocumentpageResponse EzsigntemplatedocumentpageResponse
...
func (o *EzsigntemplatedocumentpageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatedocumentpageResponse := _EzsigntemplatedocumentpageResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatedocumentpageResponse)

	if err != nil {
		return err
	}

	*o = EzsigntemplatedocumentpageResponse(varEzsigntemplatedocumentpageResponse)
