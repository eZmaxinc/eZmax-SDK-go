...
func (o *EzsigntemplatesignerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatesignerResponse := _EzsigntemplatesignerResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatesignerResponse)

	if err != nil {
		return err
	}

	*o = EzsigntemplatesignerResponse(varEzsigntemplatesignerResponse)
