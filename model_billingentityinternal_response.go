...
type _BillingentityinternalResponse BillingentityinternalResponse
...
func (o *BillingentityinternalResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBillingentityinternalResponse := _BillingentityinternalResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBillingentityinternalResponse)

	if err != nil {
		return err
	}

	*o = BillingentityinternalResponse(varBillingentityinternalResponse)
