...
type ApiDomainGetAutocompleteV2Request struct {
	ctx context.Context
	ApiService *ObjectDomainAPIService
	sSelector string
...
func (r ApiDomainGetAutocompleteV2Request) EFilterActive(eFilterActive string) ApiDomainGetAutocompleteV2Request {
	r.eFilterActive = &eFilterActive
	return r
}

// Allow to filter the returned results
func (r ApiDomainGetAutocompleteV2Request) SQuery(sQuery string) ApiDomainGetAutocompleteV2Request {
	r.sQuery = &sQuery
	return r
}

func (r ApiDomainGetAutocompleteV2Request) AcceptLanguage(acceptLanguage HeaderAcceptLanguage) ApiDomainGetAutocompleteV2Request {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiDomainGetAutocompleteV2Request) Execute() (*DomainGetAutocompleteV2Response, *http.Response, error) {
	return r.ApiService.DomainGetAutocompleteV2Execute(r)
}

/*
DomainGetAutocompleteV2 Retrieve Domain and IDs

Get the list of Domains to be used in a dropdown or autocomplete control.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param sSelector The type of Domain to return
 @return ApiDomainGetAutocompleteV2Request
*/
func (a *ObjectDomainAPIService) DomainGetAutocompleteV2(ctx context.Context, sSelector string) ApiDomainGetAutocompleteV2Request {
	return ApiDomainGetAutocompleteV2Request{
		ApiService: a,
		ctx: ctx,
		sSelector: sSelector,
...
func (a *ObjectDomainAPIService) DomainGetAutocompleteV2Execute(r ApiDomainGetAutocompleteV2Request) (*DomainGetAutocompleteV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DomainGetAutocompleteV2Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectDomainAPIService.DomainGetAutocompleteV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2/object/domain/getAutocomplete/{sSelector}"
