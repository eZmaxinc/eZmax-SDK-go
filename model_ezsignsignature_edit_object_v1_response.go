...
type _EzsignsignatureEditObjectV1Response EzsignsignatureEditObjectV1Response
...
func (o *EzsignsignatureEditObjectV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignsignatureEditObjectV1Response := _EzsignsignatureEditObjectV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignsignatureEditObjectV1Response)

	if err != nil {
		return err
	}

	*o = EzsignsignatureEditObjectV1Response(varEzsignsignatureEditObjectV1Response)

	return err
}

type NullableEzsignsignatureEditObjectV1Response struct {
	value *EzsignsignatureEditObjectV1Response
	isSet bool
}

func (v NullableEzsignsignatureEditObjectV1Response) Get() *EzsignsignatureEditObjectV1Response {
	return v.value
}

func (v *NullableEzsignsignatureEditObjectV1Response) Set(val *EzsignsignatureEditObjectV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignsignatureEditObjectV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignsignatureEditObjectV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignsignatureEditObjectV1Response(val *EzsignsignatureEditObjectV1Response) *NullableEzsignsignatureEditObjectV1Response {
	return &NullableEzsignsignatureEditObjectV1Response{value: val, isSet: true}
}

func (v NullableEzsignsignatureEditObjectV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignsignatureEditObjectV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
