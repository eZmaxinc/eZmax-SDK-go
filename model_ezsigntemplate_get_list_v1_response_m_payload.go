...
func NewEzsigntemplateGetListV1ResponseMPayload(aObjEzsigntemplate []EzsigntemplateListElement, iRowReturned int32, iRowFiltered int32) *EzsigntemplateGetListV1ResponseMPayload {
