...
type _EzsignfolderSendV3Response EzsignfolderSendV3Response
...
func (o *EzsignfolderSendV3Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfolderSendV3Response := _EzsignfolderSendV3Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfolderSendV3Response)

	if err != nil {
		return err
	}

	*o = EzsignfolderSendV3Response(varEzsignfolderSendV3Response)
