...
// checks if the EzsignfolderResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignfolderResponseV3{}

// EzsignfolderResponseV3 An Ezsignfolder Object
type EzsignfolderResponseV3 struct {
...
type _EzsignfolderResponseV3 EzsignfolderResponseV3
...
func (o EzsignfolderResponseV3) MarshalJSON() ([]byte, error) {
...
func (o EzsignfolderResponseV3) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignfolderResponseV3) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfolderResponseV3 := _EzsignfolderResponseV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfolderResponseV3)

	if err != nil {
		return err
	}

	*o = EzsignfolderResponseV3(varEzsignfolderResponseV3)

	return err
}

type NullableEzsignfolderResponseV3 struct {
	value *EzsignfolderResponseV3
	isSet bool
}

func (v NullableEzsignfolderResponseV3) Get() *EzsignfolderResponseV3 {
	return v.value
}

func (v *NullableEzsignfolderResponseV3) Set(val *EzsignfolderResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignfolderResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignfolderResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignfolderResponseV3(val *EzsignfolderResponseV3) *NullableEzsignfolderResponseV3 {
	return &NullableEzsignfolderResponseV3{value: val, isSet: true}
}

func (v NullableEzsignfolderResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignfolderResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
