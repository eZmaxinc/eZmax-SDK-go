...
type _UsergroupdelegationEditObjectV1Request UsergroupdelegationEditObjectV1Request
...
func (o *UsergroupdelegationEditObjectV1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varUsergroupdelegationEditObjectV1Request := _UsergroupdelegationEditObjectV1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsergroupdelegationEditObjectV1Request)

	if err != nil {
		return err
	}

	*o = UsergroupdelegationEditObjectV1Request(varUsergroupdelegationEditObjectV1Request)
