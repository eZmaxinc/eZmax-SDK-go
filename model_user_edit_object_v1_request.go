...
type _UserEditObjectV1Request UserEditObjectV1Request
...
func (o *UserEditObjectV1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varUserEditObjectV1Request := _UserEditObjectV1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserEditObjectV1Request)

	if err != nil {
		return err
	}

	*o = UserEditObjectV1Request(varUserEditObjectV1Request)
