...
// checks if the EzsignfolderUnsendV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignfolderUnsendV1Response{}

// EzsignfolderUnsendV1Response Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/unsend
type EzsignfolderUnsendV1Response struct {
	ObjDebugPayload CommonResponseObjDebugPayload `json:"objDebugPayload"`
	ObjDebug *CommonResponseObjDebug `json:"objDebug,omitempty"`
}

type _EzsignfolderUnsendV1Response EzsignfolderUnsendV1Response
...
func NewEzsignfolderUnsendV1Response(objDebugPayload CommonResponseObjDebugPayload) *EzsignfolderUnsendV1Response {
...
func (o EzsignfolderUnsendV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignfolderUnsendV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfolderUnsendV1Response := _EzsignfolderUnsendV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfolderUnsendV1Response)

	if err != nil {
		return err
	}

	*o = EzsignfolderUnsendV1Response(varEzsignfolderUnsendV1Response)
