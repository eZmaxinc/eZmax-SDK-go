...
// checks if the EzsignsignaturecustomdateRequestCompoundV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignsignaturecustomdateRequestCompoundV2{}

// EzsignsignaturecustomdateRequestCompoundV2 An Ezsignsignaturecustomdate Object and children to create a complete structure
type EzsignsignaturecustomdateRequestCompoundV2 struct {
...
type _EzsignsignaturecustomdateRequestCompoundV2 EzsignsignaturecustomdateRequestCompoundV2
...
func NewEzsignsignaturecustomdateRequestCompoundV2(iEzsignsignaturecustomdateOffsetx int32, iEzsignsignaturecustomdateOffsety int32, sEzsignsignaturecustomdateFormat string) *EzsignsignaturecustomdateRequestCompoundV2 {
	this := EzsignsignaturecustomdateRequestCompoundV2{}
...
func (o EzsignsignaturecustomdateRequestCompoundV2) MarshalJSON() ([]byte, error) {
...
func (o EzsignsignaturecustomdateRequestCompoundV2) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignsignaturecustomdateRequestCompoundV2) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignsignaturecustomdateRequestCompoundV2 := _EzsignsignaturecustomdateRequestCompoundV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignsignaturecustomdateRequestCompoundV2)

	if err != nil {
		return err
	}

	*o = EzsignsignaturecustomdateRequestCompoundV2(varEzsignsignaturecustomdateRequestCompoundV2)

	return err
}

type NullableEzsignsignaturecustomdateRequestCompoundV2 struct {
	value *EzsignsignaturecustomdateRequestCompoundV2
	isSet bool
}

func (v NullableEzsignsignaturecustomdateRequestCompoundV2) Get() *EzsignsignaturecustomdateRequestCompoundV2 {
	return v.value
}

func (v *NullableEzsignsignaturecustomdateRequestCompoundV2) Set(val *EzsignsignaturecustomdateRequestCompoundV2) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignsignaturecustomdateRequestCompoundV2) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignsignaturecustomdateRequestCompoundV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignsignaturecustomdateRequestCompoundV2(val *EzsignsignaturecustomdateRequestCompoundV2) *NullableEzsignsignaturecustomdateRequestCompoundV2 {
	return &NullableEzsignsignaturecustomdateRequestCompoundV2{value: val, isSet: true}
}

func (v NullableEzsignsignaturecustomdateRequestCompoundV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignsignaturecustomdateRequestCompoundV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
