...
// checks if the ColleagueRequestV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ColleagueRequestV2{}

// ColleagueRequestV2 A Colleague Object
type ColleagueRequestV2 struct {
...
type _ColleagueRequestV2 ColleagueRequestV2
...
func (o ColleagueRequestV2) MarshalJSON() ([]byte, error) {
...
func (o ColleagueRequestV2) ToMap() (map[string]interface{}, error) {
...
func (o *ColleagueRequestV2) UnmarshalJSON(data []byte) (err error) {
	...
	varColleagueRequestV2 := _ColleagueRequestV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varColleagueRequestV2)

	if err != nil {
		return err
	}

	*o = ColleagueRequestV2(varColleagueRequestV2)

	return err
}

type NullableColleagueRequestV2 struct {
	value *ColleagueRequestV2
	isSet bool
}

func (v NullableColleagueRequestV2) Get() *ColleagueRequestV2 {
	return v.value
}

func (v *NullableColleagueRequestV2) Set(val *ColleagueRequestV2) {
	v.value = val
	v.isSet = true
}

func (v NullableColleagueRequestV2) IsSet() bool {
	return v.isSet
}

func (v *NullableColleagueRequestV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableColleagueRequestV2(val *ColleagueRequestV2) *NullableColleagueRequestV2 {
	return &NullableColleagueRequestV2{value: val, isSet: true}
}

func (v NullableColleagueRequestV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableColleagueRequestV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
