...
type ApiEzsigntemplatepublicDeleteObjectV1Request struct {
	ctx context.Context
	ApiService *ObjectEzsigntemplatepublicAPIService
	pkiEzsigntemplatepublicID int32
}

func (r ApiEzsigntemplatepublicDeleteObjectV1Request) Execute() (*EzsigntemplatepublicDeleteObjectV1Response, *http.Response, error) {
	return r.ApiService.EzsigntemplatepublicDeleteObjectV1Execute(r)
}

/*
EzsigntemplatepublicDeleteObjectV1 Delete an existing Ezsigntemplatepublic



 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiEzsigntemplatepublicID The unique ID of the Ezsigntemplatepublic
 @return ApiEzsigntemplatepublicDeleteObjectV1Request
*/
func (a *ObjectEzsigntemplatepublicAPIService) EzsigntemplatepublicDeleteObjectV1(ctx context.Context, pkiEzsigntemplatepublicID int32) ApiEzsigntemplatepublicDeleteObjectV1Request {
	return ApiEzsigntemplatepublicDeleteObjectV1Request{
		ApiService: a,
		ctx: ctx,
...
func (a *ObjectEzsigntemplatepublicAPIService) EzsigntemplatepublicDeleteObjectV1Execute(r ApiEzsigntemplatepublicDeleteObjectV1Request) (*EzsigntemplatepublicDeleteObjectV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EzsigntemplatepublicDeleteObjectV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectEzsigntemplatepublicAPIService.EzsigntemplatepublicDeleteObjectV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
