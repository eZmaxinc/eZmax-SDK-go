...
type _EzsigntemplateGetAutocompleteV2ResponseMPayload EzsigntemplateGetAutocompleteV2ResponseMPayload
...
func (o *EzsigntemplateGetAutocompleteV2ResponseMPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplateGetAutocompleteV2ResponseMPayload := _EzsigntemplateGetAutocompleteV2ResponseMPayload{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplateGetAutocompleteV2ResponseMPayload)

	if err != nil {
		return err
	}

	*o = EzsigntemplateGetAutocompleteV2ResponseMPayload(varEzsigntemplateGetAutocompleteV2ResponseMPayload)
