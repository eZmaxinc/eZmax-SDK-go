...
// checks if the SupplyListElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupplyListElement{}

// SupplyListElement A Supply List Element
type SupplyListElement struct {
...
func (o SupplyListElement) MarshalJSON() ([]byte, error) {
...
func (o SupplyListElement) ToMap() (map[string]interface{}, error) {
...
func (o *SupplyListElement) UnmarshalJSON(data []byte) (err error) {
	...
	varSupplyListElement := _SupplyListElement{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSupplyListElement)

	if err != nil {
		return err
	}

	*o = SupplyListElement(varSupplyListElement)

	return err
}

type NullableSupplyListElement struct {
	value *SupplyListElement
	isSet bool
}

func (v NullableSupplyListElement) Get() *SupplyListElement {
	return v.value
}

func (v *NullableSupplyListElement) Set(val *SupplyListElement) {
	v.value = val
	v.isSet = true
}

func (v NullableSupplyListElement) IsSet() bool {
	return v.isSet
}

func (v *NullableSupplyListElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupplyListElement(val *SupplyListElement) *NullableSupplyListElement {
	return &NullableSupplyListElement{value: val, isSet: true}
}

func (v NullableSupplyListElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupplyListElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
