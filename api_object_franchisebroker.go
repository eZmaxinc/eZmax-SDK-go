...
func (r ApiFranchisebrokerGetAutocompleteV1Request) Execute() (CommonGetAutocompleteV1Response, *_nethttp.Response, error) {
 ...
 */
func (a *ObjectFranchisebrokerApiService) FranchisebrokerGetAutocompleteV1Execute(r ApiFranchisebrokerGetAutocompleteV1Request) (CommonGetAutocompleteV1Response, *_nethttp.Response, error) {
	var (
