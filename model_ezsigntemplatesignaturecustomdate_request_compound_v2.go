...
// checks if the EzsigntemplatesignaturecustomdateRequestCompoundV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplatesignaturecustomdateRequestCompoundV2{}

// EzsigntemplatesignaturecustomdateRequestCompoundV2 An Ezsigntemplatesignaturecustomdate Object and children to create a complete structure
type EzsigntemplatesignaturecustomdateRequestCompoundV2 struct {
...
type _EzsigntemplatesignaturecustomdateRequestCompoundV2 EzsigntemplatesignaturecustomdateRequestCompoundV2
...
func NewEzsigntemplatesignaturecustomdateRequestCompoundV2(iEzsigntemplatesignaturecustomdateOffsetx int32, iEzsigntemplatesignaturecustomdateOffsety int32, sEzsigntemplatesignaturecustomdateFormat string) *EzsigntemplatesignaturecustomdateRequestCompoundV2 {
	this := EzsigntemplatesignaturecustomdateRequestCompoundV2{}
...
func (o EzsigntemplatesignaturecustomdateRequestCompoundV2) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplatesignaturecustomdateRequestCompoundV2) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplatesignaturecustomdateRequestCompoundV2) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatesignaturecustomdateRequestCompoundV2 := _EzsigntemplatesignaturecustomdateRequestCompoundV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatesignaturecustomdateRequestCompoundV2)

	if err != nil {
		return err
	}

	*o = EzsigntemplatesignaturecustomdateRequestCompoundV2(varEzsigntemplatesignaturecustomdateRequestCompoundV2)

	return err
}

type NullableEzsigntemplatesignaturecustomdateRequestCompoundV2 struct {
	value *EzsigntemplatesignaturecustomdateRequestCompoundV2
	isSet bool
}

func (v NullableEzsigntemplatesignaturecustomdateRequestCompoundV2) Get() *EzsigntemplatesignaturecustomdateRequestCompoundV2 {
	return v.value
}

func (v *NullableEzsigntemplatesignaturecustomdateRequestCompoundV2) Set(val *EzsigntemplatesignaturecustomdateRequestCompoundV2) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplatesignaturecustomdateRequestCompoundV2) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplatesignaturecustomdateRequestCompoundV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplatesignaturecustomdateRequestCompoundV2(val *EzsigntemplatesignaturecustomdateRequestCompoundV2) *NullableEzsigntemplatesignaturecustomdateRequestCompoundV2 {
	return &NullableEzsigntemplatesignaturecustomdateRequestCompoundV2{value: val, isSet: true}
}

func (v NullableEzsigntemplatesignaturecustomdateRequestCompoundV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplatesignaturecustomdateRequestCompoundV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
