...
type _EzsignbulksendCreateObjectV1Response EzsignbulksendCreateObjectV1Response
...
func NewEzsignbulksendCreateObjectV1Response(mPayload EzsignbulksendCreateObjectV1ResponseMPayload, objDebugPayload CommonResponseObjDebugPayload) *EzsignbulksendCreateObjectV1Response {
...
func (o *EzsignbulksendCreateObjectV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignbulksendCreateObjectV1Response := _EzsignbulksendCreateObjectV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignbulksendCreateObjectV1Response)

	if err != nil {
		return err
	}

	*o = EzsignbulksendCreateObjectV1Response(varEzsignbulksendCreateObjectV1Response)
