...
// checks if the EzsigntemplateResponseCompoundV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplateResponseCompoundV4{}

// EzsigntemplateResponseCompoundV4 A Ezsigntemplate Object
type EzsigntemplateResponseCompoundV4 struct {
	...
	AObjEzsigntemplatesigner []EzsigntemplatesignerResponseCompoundV3 `json:"a_objEzsigntemplatesigner"`
	AObjEzsigntemplateannotation []EzsigntemplateannotationResponseCompound `json:"a_objEzsigntemplateannotation,omitempty"`
}

type _EzsigntemplateResponseCompoundV4 EzsigntemplateResponseCompoundV4
...
func NewEzsigntemplateResponseCompoundV4(pkiEzsigntemplateID int32, fkiLanguageID int32, sLanguageNameX string, sEzsigntemplateDescription string, bEzsigntemplateAdminonly bool, objAudit CommonAudit, bEzsigntemplateEditallowed bool, aObjEzsigntemplatesigner []EzsigntemplatesignerResponseCompoundV3) *EzsigntemplateResponseCompoundV4 {
	this := EzsigntemplateResponseCompoundV4{}
...
func (o EzsigntemplateResponseCompoundV4) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplateResponseCompoundV4) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplateResponseCompoundV4) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplateResponseCompoundV4 := _EzsigntemplateResponseCompoundV4{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplateResponseCompoundV4)

	if err != nil {
		return err
	}

	*o = EzsigntemplateResponseCompoundV4(varEzsigntemplateResponseCompoundV4)

	return err
}

type NullableEzsigntemplateResponseCompoundV4 struct {
	value *EzsigntemplateResponseCompoundV4
	isSet bool
}

func (v NullableEzsigntemplateResponseCompoundV4) Get() *EzsigntemplateResponseCompoundV4 {
	return v.value
}

func (v *NullableEzsigntemplateResponseCompoundV4) Set(val *EzsigntemplateResponseCompoundV4) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplateResponseCompoundV4) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplateResponseCompoundV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplateResponseCompoundV4(val *EzsigntemplateResponseCompoundV4) *NullableEzsigntemplateResponseCompoundV4 {
	return &NullableEzsigntemplateResponseCompoundV4{value: val, isSet: true}
}

func (v NullableEzsigntemplateResponseCompoundV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplateResponseCompoundV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
