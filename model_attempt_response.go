...
type _AttemptResponse AttemptResponse
...
func (o *AttemptResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAttemptResponse := _AttemptResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAttemptResponse)

	if err != nil {
		return err
	}

	*o = AttemptResponse(varAttemptResponse)
