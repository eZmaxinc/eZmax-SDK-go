...
type _PaymenttermCreateObjectV1Response PaymenttermCreateObjectV1Response
...
func NewPaymenttermCreateObjectV1Response(mPayload PaymenttermCreateObjectV1ResponseMPayload, objDebugPayload CommonResponseObjDebugPayload) *PaymenttermCreateObjectV1Response {
...
func (o *PaymenttermCreateObjectV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymenttermCreateObjectV1Response := _PaymenttermCreateObjectV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymenttermCreateObjectV1Response)

	if err != nil {
		return err
	}

	*o = PaymenttermCreateObjectV1Response(varPaymenttermCreateObjectV1Response)
