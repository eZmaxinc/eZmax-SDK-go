...
// checks if the UserCreateEzsignuserV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserCreateEzsignuserV1Response{}

// UserCreateEzsignuserV1Response Response for POST /1/module/user/createEzsignuser
type UserCreateEzsignuserV1Response struct {
	CommonResponse
	MPayload UserCreateEzsignuserV1ResponseMPayload `json:"mPayload"`
}

type _UserCreateEzsignuserV1Response UserCreateEzsignuserV1Response
...
func NewUserCreateEzsignuserV1Response(mPayload UserCreateEzsignuserV1ResponseMPayload, objDebugPayload CommonResponseObjDebugPayload) *UserCreateEzsignuserV1Response {
...
func (o UserCreateEzsignuserV1Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["mPayload"] = o.MPayload
	return toSerialize, nil
}

func (o *UserCreateEzsignuserV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUserCreateEzsignuserV1Response := _UserCreateEzsignuserV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserCreateEzsignuserV1Response)

	if err != nil {
		return err
	}

	*o = UserCreateEzsignuserV1Response(varUserCreateEzsignuserV1Response)
