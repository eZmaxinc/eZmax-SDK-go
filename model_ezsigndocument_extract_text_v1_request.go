...
// checks if the EzsigndocumentExtractTextV1Request type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigndocumentExtractTextV1Request{}

// EzsigndocumentExtractTextV1Request Request for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/extractText
type EzsigndocumentExtractTextV1Request struct {
...
type _EzsigndocumentExtractTextV1Request EzsigndocumentExtractTextV1Request
...
func NewEzsigndocumentExtractTextV1Request(iPage int32) *EzsigndocumentExtractTextV1Request {
	this := EzsigndocumentExtractTextV1Request{}
	this.IPage = iPage
	return &this
}
...
func (o EzsigndocumentExtractTextV1Request) MarshalJSON() ([]byte, error) {
...
func (o EzsigndocumentExtractTextV1Request) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigndocumentExtractTextV1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigndocumentExtractTextV1Request := _EzsigndocumentExtractTextV1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigndocumentExtractTextV1Request)

	if err != nil {
		return err
	}

	*o = EzsigndocumentExtractTextV1Request(varEzsigndocumentExtractTextV1Request)

	return err
}

type NullableEzsigndocumentExtractTextV1Request struct {
	value *EzsigndocumentExtractTextV1Request
	isSet bool
}

func (v NullableEzsigndocumentExtractTextV1Request) Get() *EzsigndocumentExtractTextV1Request {
	return v.value
}

func (v *NullableEzsigndocumentExtractTextV1Request) Set(val *EzsigndocumentExtractTextV1Request) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigndocumentExtractTextV1Request) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigndocumentExtractTextV1Request) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigndocumentExtractTextV1Request(val *EzsigndocumentExtractTextV1Request) *NullableEzsigndocumentExtractTextV1Request {
	return &NullableEzsigndocumentExtractTextV1Request{value: val, isSet: true}
}

func (v NullableEzsigndocumentExtractTextV1Request) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigndocumentExtractTextV1Request) UnmarshalJSON(src []byte) error {
	v.isSet = true
