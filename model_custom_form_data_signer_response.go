...
type _CustomFormDataSignerResponse CustomFormDataSignerResponse
...
func (o *CustomFormDataSignerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomFormDataSignerResponse := _CustomFormDataSignerResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomFormDataSignerResponse)

	if err != nil {
		return err
	}

	*o = CustomFormDataSignerResponse(varCustomFormDataSignerResponse)
