...
func (o *EzsigntemplatepackageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepackageResponse := _EzsigntemplatepackageResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepackageResponse)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepackageResponse(varEzsigntemplatepackageResponse)
