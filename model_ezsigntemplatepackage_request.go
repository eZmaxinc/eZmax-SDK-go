...
type _EzsigntemplatepackageRequest EzsigntemplatepackageRequest
...
func (o *EzsigntemplatepackageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepackageRequest := _EzsigntemplatepackageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepackageRequest)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepackageRequest(varEzsigntemplatepackageRequest)
