...
type ApiRejectedoffertopurchaseBatchDownloadV1Request struct {
	ctx context.Context
...
func (r ApiRejectedoffertopurchaseBatchDownloadV1Request) RejectedoffertopurchaseBatchDownloadV1Request(rejectedoffertopurchaseBatchDownloadV1Request RejectedoffertopurchaseBatchDownloadV1Request) ApiRejectedoffertopurchaseBatchDownloadV1Request {
	r.rejectedoffertopurchaseBatchDownloadV1Request = &rejectedoffertopurchaseBatchDownloadV1Request
	return r
}

func (r ApiRejectedoffertopurchaseBatchDownloadV1Request) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.RejectedoffertopurchaseBatchDownloadV1Execute(r)
}

/*
RejectedoffertopurchaseBatchDownloadV1 Download multiples attachments from a Rejectedoffertopurchase

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiRejectedoffertopurchaseID
 @return ApiRejectedoffertopurchaseBatchDownloadV1Request
*/
func (a *ObjectRejectedoffertopurchaseAPIService) RejectedoffertopurchaseBatchDownloadV1(ctx context.Context, pkiRejectedoffertopurchaseID int32) ApiRejectedoffertopurchaseBatchDownloadV1Request {
	return ApiRejectedoffertopurchaseBatchDownloadV1Request{
		ApiService: a,
		ctx: ctx,
...
//  @return *os.File
func (a *ObjectRejectedoffertopurchaseAPIService) RejectedoffertopurchaseBatchDownloadV1Execute(r ApiRejectedoffertopurchaseBatchDownloadV1Request) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectRejectedoffertopurchaseAPIService.RejectedoffertopurchaseBatchDownloadV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/batchDownload"
	...
	if r.rejectedoffertopurchaseBatchDownloadV1Request == nil {
		return localVarReturnValue, nil, reportError("rejectedoffertopurchaseBatchDownloadV1Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.rejectedoffertopurchaseBatchDownloadV1Request
	if r.ctx != nil {
...
type ApiRejectedoffertopurchaseGetAttachmentsV1Request struct {
	ctx context.Context
	ApiService *ObjectRejectedoffertopurchaseAPIService
	pkiRejectedoffertopurchaseID int32
}

func (r ApiRejectedoffertopurchaseGetAttachmentsV1Request) Execute() (*RejectedoffertopurchaseGetAttachmentsV1Response, *http.Response, error) {
	return r.ApiService.RejectedoffertopurchaseGetAttachmentsV1Execute(r)
}

/*
RejectedoffertopurchaseGetAttachmentsV1 Retrieve Rejectedoffertopurchase's attachments

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiRejectedoffertopurchaseID
 @return ApiRejectedoffertopurchaseGetAttachmentsV1Request
*/
func (a *ObjectRejectedoffertopurchaseAPIService) RejectedoffertopurchaseGetAttachmentsV1(ctx context.Context, pkiRejectedoffertopurchaseID int32) ApiRejectedoffertopurchaseGetAttachmentsV1Request {
	return ApiRejectedoffertopurchaseGetAttachmentsV1Request{
		ApiService: a,
		ctx: ctx,
		pkiRejectedoffertopurchaseID: pkiRejectedoffertopurchaseID,
...
func (a *ObjectRejectedoffertopurchaseAPIService) RejectedoffertopurchaseGetAttachmentsV1Execute(r ApiRejectedoffertopurchaseGetAttachmentsV1Request) (*RejectedoffertopurchaseGetAttachmentsV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RejectedoffertopurchaseGetAttachmentsV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectRejectedoffertopurchaseAPIService.RejectedoffertopurchaseGetAttachmentsV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getAttachments"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiRejectedoffertopurchaseID"+"}", url.PathEscape(parameterValueToString(r.pkiRejectedoffertopurchaseID, "pkiRejectedoffertopurchaseID")), -1)
