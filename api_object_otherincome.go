...
type ApiOtherincomeBatchDownloadV1Request struct {
	ctx context.Context
...
func (r ApiOtherincomeBatchDownloadV1Request) OtherincomeBatchDownloadV1Request(otherincomeBatchDownloadV1Request OtherincomeBatchDownloadV1Request) ApiOtherincomeBatchDownloadV1Request {
	r.otherincomeBatchDownloadV1Request = &otherincomeBatchDownloadV1Request
	return r
}

func (r ApiOtherincomeBatchDownloadV1Request) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.OtherincomeBatchDownloadV1Execute(r)
}

/*
OtherincomeBatchDownloadV1 Download multiples attachments from a Otherincome

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiOtherincomeID
 @return ApiOtherincomeBatchDownloadV1Request
*/
func (a *ObjectOtherincomeAPIService) OtherincomeBatchDownloadV1(ctx context.Context, pkiOtherincomeID int32) ApiOtherincomeBatchDownloadV1Request {
	return ApiOtherincomeBatchDownloadV1Request{
		ApiService: a,
		ctx: ctx,
...
//  @return *os.File
func (a *ObjectOtherincomeAPIService) OtherincomeBatchDownloadV1Execute(r ApiOtherincomeBatchDownloadV1Request) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectOtherincomeAPIService.OtherincomeBatchDownloadV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/otherincome/{pkiOtherincomeID}/batchDownload"
	...
	if r.otherincomeBatchDownloadV1Request == nil {
		return localVarReturnValue, nil, reportError("otherincomeBatchDownloadV1Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.otherincomeBatchDownloadV1Request
	if r.ctx != nil {
...
type ApiOtherincomeGetAttachmentsV1Request struct {
	ctx context.Context
	ApiService *ObjectOtherincomeAPIService
	pkiOtherincomeID int32
}

func (r ApiOtherincomeGetAttachmentsV1Request) Execute() (*OtherincomeGetAttachmentsV1Response, *http.Response, error) {
	return r.ApiService.OtherincomeGetAttachmentsV1Execute(r)
}

/*
OtherincomeGetAttachmentsV1 Retrieve Otherincome's attachments

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiOtherincomeID
 @return ApiOtherincomeGetAttachmentsV1Request
*/
func (a *ObjectOtherincomeAPIService) OtherincomeGetAttachmentsV1(ctx context.Context, pkiOtherincomeID int32) ApiOtherincomeGetAttachmentsV1Request {
	return ApiOtherincomeGetAttachmentsV1Request{
		ApiService: a,
		ctx: ctx,
		pkiOtherincomeID: pkiOtherincomeID,
...
func (a *ObjectOtherincomeAPIService) OtherincomeGetAttachmentsV1Execute(r ApiOtherincomeGetAttachmentsV1Request) (*OtherincomeGetAttachmentsV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OtherincomeGetAttachmentsV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectOtherincomeAPIService.OtherincomeGetAttachmentsV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/otherincome/{pkiOtherincomeID}/getAttachments"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiOtherincomeID"+"}", url.PathEscape(parameterValueToString(r.pkiOtherincomeID, "pkiOtherincomeID")), -1)
