...
// checks if the EzsigndocumentGetFormDataV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigndocumentGetFormDataV1Response{}

// EzsigndocumentGetFormDataV1Response Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getFormData
type EzsigndocumentGetFormDataV1Response struct {
	CommonResponse
	MPayload EzsigndocumentGetFormDataV1ResponseMPayload `json:"mPayload"`
}

type _EzsigndocumentGetFormDataV1Response EzsigndocumentGetFormDataV1Response
...
func NewEzsigndocumentGetFormDataV1Response(mPayload EzsigndocumentGetFormDataV1ResponseMPayload, objDebugPayload CommonResponseObjDebugPayload) *EzsigndocumentGetFormDataV1Response {
...
func (o EzsigndocumentGetFormDataV1Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["mPayload"] = o.MPayload
	return toSerialize, nil
}

func (o *EzsigndocumentGetFormDataV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigndocumentGetFormDataV1Response := _EzsigndocumentGetFormDataV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigndocumentGetFormDataV1Response)

	if err != nil {
		return err
	}

	*o = EzsigndocumentGetFormDataV1Response(varEzsigndocumentGetFormDataV1Response)
