...
type _UserstagedMapV1Response UserstagedMapV1Response
...
func (o *UserstagedMapV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUserstagedMapV1Response := _UserstagedMapV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserstagedMapV1Response)

	if err != nil {
		return err
	}

	*o = UserstagedMapV1Response(varUserstagedMapV1Response)
