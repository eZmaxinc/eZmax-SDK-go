...
// checks if the SystemconfigurationRequestCompoundV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemconfigurationRequestCompoundV2{}

// SystemconfigurationRequestCompoundV2 A Systemconfiguration Object and children
type SystemconfigurationRequestCompoundV2 struct {
...
type _SystemconfigurationRequestCompoundV2 SystemconfigurationRequestCompoundV2
...
func NewSystemconfigurationRequestCompoundV2(eSystemconfigurationNewexternaluseraction FieldESystemconfigurationNewexternaluseraction, eSystemconfigurationLanguage1 FieldESystemconfigurationLanguage1, eSystemconfigurationLanguage2 FieldESystemconfigurationLanguage2, bSystemconfigurationEzsignpersonnal bool, bSystemconfigurationSspr bool, iSystemconfigurationEzsignreminderhoursend int32) *SystemconfigurationRequestCompoundV2 {
	this := SystemconfigurationRequestCompoundV2{}
...
func (o SystemconfigurationRequestCompoundV2) MarshalJSON() ([]byte, error) {
...
func (o SystemconfigurationRequestCompoundV2) ToMap() (map[string]interface{}, error) {
...
func (o *SystemconfigurationRequestCompoundV2) UnmarshalJSON(data []byte) (err error) {
	...
	varSystemconfigurationRequestCompoundV2 := _SystemconfigurationRequestCompoundV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSystemconfigurationRequestCompoundV2)

	if err != nil {
		return err
	}

	*o = SystemconfigurationRequestCompoundV2(varSystemconfigurationRequestCompoundV2)

	return err
}

type NullableSystemconfigurationRequestCompoundV2 struct {
	value *SystemconfigurationRequestCompoundV2
	isSet bool
}

func (v NullableSystemconfigurationRequestCompoundV2) Get() *SystemconfigurationRequestCompoundV2 {
	return v.value
}

func (v *NullableSystemconfigurationRequestCompoundV2) Set(val *SystemconfigurationRequestCompoundV2) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemconfigurationRequestCompoundV2) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemconfigurationRequestCompoundV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemconfigurationRequestCompoundV2(val *SystemconfigurationRequestCompoundV2) *NullableSystemconfigurationRequestCompoundV2 {
	return &NullableSystemconfigurationRequestCompoundV2{value: val, isSet: true}
}

func (v NullableSystemconfigurationRequestCompoundV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemconfigurationRequestCompoundV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
