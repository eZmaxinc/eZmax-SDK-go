...
// ObjectNotificationtestAPIService ObjectNotificationtestAPI service
type ObjectNotificationtestAPIService service

type ApiNotificationtestGetElementsV1Request struct {
	ctx context.Context
	ApiService *ObjectNotificationtestAPIService
	pkiNotificationtestID int32
}

func (r ApiNotificationtestGetElementsV1Request) Execute() (*NotificationtestGetElementsV1Response, *http.Response, error) {
	return r.ApiService.NotificationtestGetElementsV1Execute(r)
}

/*
NotificationtestGetElementsV1 Retrieve an existing Notificationtest's Elements
...
func (a *ObjectNotificationtestAPIService) NotificationtestGetElementsV1Execute(r ApiNotificationtestGetElementsV1Request) (*NotificationtestGetElementsV1Response, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *NotificationtestGetElementsV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectNotificationtestAPIService.NotificationtestGetElementsV1")
	if err != nil {
