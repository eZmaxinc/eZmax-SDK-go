...
// checks if the EzsignbulksendRequestV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignbulksendRequestV2{}

// EzsignbulksendRequestV2 A Ezsignbulksend Object
type EzsignbulksendRequestV2 struct {
...
type _EzsignbulksendRequestV2 EzsignbulksendRequestV2
...
func (o EzsignbulksendRequestV2) MarshalJSON() ([]byte, error) {
...
func (o EzsignbulksendRequestV2) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignbulksendRequestV2) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignbulksendRequestV2 := _EzsignbulksendRequestV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignbulksendRequestV2)

	if err != nil {
		return err
	}

	*o = EzsignbulksendRequestV2(varEzsignbulksendRequestV2)

	return err
}

type NullableEzsignbulksendRequestV2 struct {
	value *EzsignbulksendRequestV2
	isSet bool
}

func (v NullableEzsignbulksendRequestV2) Get() *EzsignbulksendRequestV2 {
	return v.value
}

func (v *NullableEzsignbulksendRequestV2) Set(val *EzsignbulksendRequestV2) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignbulksendRequestV2) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignbulksendRequestV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignbulksendRequestV2(val *EzsignbulksendRequestV2) *NullableEzsignbulksendRequestV2 {
	return &NullableEzsignbulksendRequestV2{value: val, isSet: true}
}

func (v NullableEzsignbulksendRequestV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignbulksendRequestV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
