...
type ApiElectronicfundstransferBatchDownloadV1Request struct {
	ctx context.Context
...
func (r ApiElectronicfundstransferBatchDownloadV1Request) ElectronicfundstransferBatchDownloadV1Request(electronicfundstransferBatchDownloadV1Request ElectronicfundstransferBatchDownloadV1Request) ApiElectronicfundstransferBatchDownloadV1Request {
	r.electronicfundstransferBatchDownloadV1Request = &electronicfundstransferBatchDownloadV1Request
	return r
}

func (r ApiElectronicfundstransferBatchDownloadV1Request) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.ElectronicfundstransferBatchDownloadV1Execute(r)
}

/*
ElectronicfundstransferBatchDownloadV1 Download multiples attachments from an Electronicfundstransfer

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiElectronicfundstransferID
 @return ApiElectronicfundstransferBatchDownloadV1Request
*/
func (a *ObjectElectronicfundstransferAPIService) ElectronicfundstransferBatchDownloadV1(ctx context.Context, pkiElectronicfundstransferID int32) ApiElectronicfundstransferBatchDownloadV1Request {
	return ApiElectronicfundstransferBatchDownloadV1Request{
		ApiService: a,
		ctx: ctx,
...
//  @return *os.File
func (a *ObjectElectronicfundstransferAPIService) ElectronicfundstransferBatchDownloadV1Execute(r ApiElectronicfundstransferBatchDownloadV1Request) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectElectronicfundstransferAPIService.ElectronicfundstransferBatchDownloadV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/batchDownload"
	...
	if r.electronicfundstransferBatchDownloadV1Request == nil {
		return localVarReturnValue, nil, reportError("electronicfundstransferBatchDownloadV1Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.electronicfundstransferBatchDownloadV1Request
	if r.ctx != nil {
...
type ApiElectronicfundstransferGetAttachmentsV1Request struct {
	ctx context.Context
	ApiService *ObjectElectronicfundstransferAPIService
	pkiElectronicfundstransferID int32
}

func (r ApiElectronicfundstransferGetAttachmentsV1Request) Execute() (*ElectronicfundstransferGetAttachmentsV1Response, *http.Response, error) {
	return r.ApiService.ElectronicfundstransferGetAttachmentsV1Execute(r)
}

/*
ElectronicfundstransferGetAttachmentsV1 Retrieve Electronicfundstransfer's attachments

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiElectronicfundstransferID
 @return ApiElectronicfundstransferGetAttachmentsV1Request
*/
func (a *ObjectElectronicfundstransferAPIService) ElectronicfundstransferGetAttachmentsV1(ctx context.Context, pkiElectronicfundstransferID int32) ApiElectronicfundstransferGetAttachmentsV1Request {
	return ApiElectronicfundstransferGetAttachmentsV1Request{
		ApiService: a,
		ctx: ctx,
		pkiElectronicfundstransferID: pkiElectronicfundstransferID,
...
func (a *ObjectElectronicfundstransferAPIService) ElectronicfundstransferGetAttachmentsV1Execute(r ApiElectronicfundstransferGetAttachmentsV1Request) (*ElectronicfundstransferGetAttachmentsV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ElectronicfundstransferGetAttachmentsV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectElectronicfundstransferAPIService.ElectronicfundstransferGetAttachmentsV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/getAttachments"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiElectronicfundstransferID"+"}", url.PathEscape(parameterValueToString(r.pkiElectronicfundstransferID, "pkiElectronicfundstransferID")), -1)
...
type ApiElectronicfundstransferImportIntoEDMV1Request struct {
	ctx context.Context
	ApiService *ObjectElectronicfundstransferAPIService
	pkiElectronicfundstransferID int32
...
func (r ApiElectronicfundstransferImportIntoEDMV1Request) ElectronicfundstransferImportIntoEDMV1Request(electronicfundstransferImportIntoEDMV1Request ElectronicfundstransferImportIntoEDMV1Request) ApiElectronicfundstransferImportIntoEDMV1Request {
	r.electronicfundstransferImportIntoEDMV1Request = &electronicfundstransferImportIntoEDMV1Request
	return r
}

func (r ApiElectronicfundstransferImportIntoEDMV1Request) Execute() (*ElectronicfundstransferImportIntoEDMV1Response, *http.Response, error) {
	return r.ApiService.ElectronicfundstransferImportIntoEDMV1Execute(r)
}

/*
ElectronicfundstransferImportIntoEDMV1 Import attachments into the Electronicfundstransfer



 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiElectronicfundstransferID
 @return ApiElectronicfundstransferImportIntoEDMV1Request
*/
func (a *ObjectElectronicfundstransferAPIService) ElectronicfundstransferImportIntoEDMV1(ctx context.Context, pkiElectronicfundstransferID int32) ApiElectronicfundstransferImportIntoEDMV1Request {
	return ApiElectronicfundstransferImportIntoEDMV1Request{
		ApiService: a,
		ctx: ctx,
		pkiElectronicfundstransferID: pkiElectronicfundstransferID,
...
func (a *ObjectElectronicfundstransferAPIService) ElectronicfundstransferImportIntoEDMV1Execute(r ApiElectronicfundstransferImportIntoEDMV1Request) (*ElectronicfundstransferImportIntoEDMV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ElectronicfundstransferImportIntoEDMV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectElectronicfundstransferAPIService.ElectronicfundstransferImportIntoEDMV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/importIntoEDM"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiElectronicfundstransferID"+"}", url.PathEscape(parameterValueToString(r.pkiElectronicfundstransferID, "pkiElectronicfundstransferID")), -1)
	...
	if r.electronicfundstransferImportIntoEDMV1Request == nil {
		return localVarReturnValue, nil, reportError("electronicfundstransferImportIntoEDMV1Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.electronicfundstransferImportIntoEDMV1Request
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Authorization"]; ok {
