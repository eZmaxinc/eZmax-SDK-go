...
type ApiEzsignfolderGetEzsignfoldersignerassociationsmineV1Request struct {
	ctx context.Context
	ApiService *ObjectEzsignfolderAPIService
	pkiEzsignfolderID int32
}

func (r ApiEzsignfolderGetEzsignfoldersignerassociationsmineV1Request) Execute() (*EzsignfolderGetEzsignfoldersignerassociationsmineV1Response, *http.Response, error) {
	return r.ApiService.EzsignfolderGetEzsignfoldersignerassociationsmineV1Execute(r)
}

/*
EzsignfolderGetEzsignfoldersignerassociationsmineV1 Retrieve your own Ezsignfoldersignerassociations from an existing Ezsignfolder



 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiEzsignfolderID
 @return ApiEzsignfolderGetEzsignfoldersignerassociationsmineV1Request
*/
func (a *ObjectEzsignfolderAPIService) EzsignfolderGetEzsignfoldersignerassociationsmineV1(ctx context.Context, pkiEzsignfolderID int32) ApiEzsignfolderGetEzsignfoldersignerassociationsmineV1Request {
	return ApiEzsignfolderGetEzsignfoldersignerassociationsmineV1Request{
		ApiService: a,
		ctx: ctx,
		pkiEzsignfolderID: pkiEzsignfolderID,
...
func (a *ObjectEzsignfolderAPIService) EzsignfolderGetEzsignfoldersignerassociationsmineV1Execute(r ApiEzsignfolderGetEzsignfoldersignerassociationsmineV1Request) (*EzsignfolderGetEzsignfoldersignerassociationsmineV1Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EzsignfolderGetEzsignfoldersignerassociationsmineV1Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectEzsignfolderAPIService.EzsignfolderGetEzsignfoldersignerassociationsmineV1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociationsmine"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiEzsignfolderID"+"}", url.PathEscape(parameterValueToString(r.pkiEzsignfolderID, "pkiEzsignfolderID")), -1)
...
type ApiEzsignfolderSendV2Request struct {
	ctx context.Context
	ApiService *ObjectEzsignfolderAPIService
	pkiEzsignfolderID int32
...
func (r ApiEzsignfolderSendV2Request) EzsignfolderSendV2Request(ezsignfolderSendV2Request EzsignfolderSendV2Request) ApiEzsignfolderSendV2Request {
	r.ezsignfolderSendV2Request = &ezsignfolderSendV2Request
	return r
}

func (r ApiEzsignfolderSendV2Request) Execute() (*EzsignfolderSendV2Response, *http.Response, error) {
	return r.ApiService.EzsignfolderSendV2Execute(r)
}

/*
EzsignfolderSendV2 Send the Ezsignfolder to the signatories for signature



 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiEzsignfolderID
 @return ApiEzsignfolderSendV2Request

Deprecated
*/
func (a *ObjectEzsignfolderAPIService) EzsignfolderSendV2(ctx context.Context, pkiEzsignfolderID int32) ApiEzsignfolderSendV2Request {
	return ApiEzsignfolderSendV2Request{
		ApiService: a,
		ctx: ctx,
		pkiEzsignfolderID: pkiEzsignfolderID,
...
// Deprecated
func (a *ObjectEzsignfolderAPIService) EzsignfolderSendV2Execute(r ApiEzsignfolderSendV2Request) (*EzsignfolderSendV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EzsignfolderSendV2Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectEzsignfolderAPIService.EzsignfolderSendV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2/object/ezsignfolder/{pkiEzsignfolderID}/send"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiEzsignfolderID"+"}", url.PathEscape(parameterValueToString(r.pkiEzsignfolderID, "pkiEzsignfolderID")), -1)
	...
	if r.ezsignfolderSendV2Request == nil {
		return localVarReturnValue, nil, reportError("ezsignfolderSendV2Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.ezsignfolderSendV2Request
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Authorization"]; ok {
