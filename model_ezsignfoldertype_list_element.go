...
type _EzsignfoldertypeListElement EzsignfoldertypeListElement
...
func (o *EzsignfoldertypeListElement) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfoldertypeListElement := _EzsignfoldertypeListElement{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfoldertypeListElement)

	if err != nil {
		return err
	}

	*o = EzsignfoldertypeListElement(varEzsignfoldertypeListElement)
