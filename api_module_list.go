...
func (r ApiListGetListpresentationV1Request) Execute() (ListGetListpresentationV1Response, *_nethttp.Response, error) {
...
func (a *ModuleListApiService) ListGetListpresentationV1Execute(r ApiListGetListpresentationV1Request) (ListGetListpresentationV1Response, *_nethttp.Response, error) {
	var (
...
func (r ApiListSaveListpresentationV1Request) Execute() (ListSaveListpresentationV1Response, *_nethttp.Response, error) {
...
func (a *ModuleListApiService) ListSaveListpresentationV1Execute(r ApiListSaveListpresentationV1Request) (ListSaveListpresentationV1Response, *_nethttp.Response, error) {
	var (
