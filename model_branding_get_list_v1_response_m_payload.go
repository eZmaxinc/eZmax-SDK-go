...
type _BrandingGetListV1ResponseMPayload BrandingGetListV1ResponseMPayload
...
func (o *BrandingGetListV1ResponseMPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varBrandingGetListV1ResponseMPayload := _BrandingGetListV1ResponseMPayload{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBrandingGetListV1ResponseMPayload)

	if err != nil {
		return err
	}

	*o = BrandingGetListV1ResponseMPayload(varBrandingGetListV1ResponseMPayload)
