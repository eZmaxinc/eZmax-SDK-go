...
// checks if the UsergroupexternalResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsergroupexternalResponse{}

// UsergroupexternalResponse A Usergroupexternal Object
type UsergroupexternalResponse struct {
...
type _UsergroupexternalResponse UsergroupexternalResponse
...
func NewUsergroupexternalResponse(pkiUsergroupexternalID int32, sUsergroupexternalName string, sUsergroupexternalID string) *UsergroupexternalResponse {
	this := UsergroupexternalResponse{}
...
func (o UsergroupexternalResponse) MarshalJSON() ([]byte, error) {
...
func (o UsergroupexternalResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UsergroupexternalResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUsergroupexternalResponse := _UsergroupexternalResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsergroupexternalResponse)

	if err != nil {
		return err
	}

	*o = UsergroupexternalResponse(varUsergroupexternalResponse)

	return err
}

type NullableUsergroupexternalResponse struct {
	value *UsergroupexternalResponse
	isSet bool
}

func (v NullableUsergroupexternalResponse) Get() *UsergroupexternalResponse {
	return v.value
}

func (v *NullableUsergroupexternalResponse) Set(val *UsergroupexternalResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUsergroupexternalResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUsergroupexternalResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsergroupexternalResponse(val *UsergroupexternalResponse) *NullableUsergroupexternalResponse {
	return &NullableUsergroupexternalResponse{value: val, isSet: true}
}

func (v NullableUsergroupexternalResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUsergroupexternalResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
