...
type _BillingentityinternalListElement BillingentityinternalListElement
...
func (o *BillingentityinternalListElement) UnmarshalJSON(data []byte) (err error) {
	...
	varBillingentityinternalListElement := _BillingentityinternalListElement{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBillingentityinternalListElement)

	if err != nil {
		return err
	}

	*o = BillingentityinternalListElement(varBillingentityinternalListElement)
