...
// checks if the EzsignfolderEditObjectV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignfolderEditObjectV1Response{}

// EzsignfolderEditObjectV1Response Response for PUT /1/object/ezsignfolder/{pkiEzsignfolderID}
type EzsignfolderEditObjectV1Response struct {
	ObjDebugPayload CommonResponseObjDebugPayload `json:"objDebugPayload"`
	ObjDebug *CommonResponseObjDebug `json:"objDebug,omitempty"`
}

type _EzsignfolderEditObjectV1Response EzsignfolderEditObjectV1Response
...
func (o EzsignfolderEditObjectV1Response) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignfolderEditObjectV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfolderEditObjectV1Response := _EzsignfolderEditObjectV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfolderEditObjectV1Response)

	if err != nil {
		return err
	}

	*o = EzsignfolderEditObjectV1Response(varEzsignfolderEditObjectV1Response)
