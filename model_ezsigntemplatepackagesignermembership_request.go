...
type _EzsigntemplatepackagesignermembershipRequest EzsigntemplatepackagesignermembershipRequest
...
func (o *EzsigntemplatepackagesignermembershipRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepackagesignermembershipRequest := _EzsigntemplatepackagesignermembershipRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepackagesignermembershipRequest)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepackagesignermembershipRequest(varEzsigntemplatepackagesignermembershipRequest)
