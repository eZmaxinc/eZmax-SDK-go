...
// checks if the EzsignbulksendsignermappingResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignbulksendsignermappingResponseV3{}

// EzsignbulksendsignermappingResponseV3 A Ezsignbulksendsignermapping Object
type EzsignbulksendsignermappingResponseV3 struct {
...
type _EzsignbulksendsignermappingResponseV3 EzsignbulksendsignermappingResponseV3
...
func NewEzsignbulksendsignermappingResponseV3(pkiEzsignbulksendsignermappingID int32, fkiEzsignbulksendID int32, sEzsignbulksendsignermappingDescription string) *EzsignbulksendsignermappingResponseV3 {
	this := EzsignbulksendsignermappingResponseV3{}
...
func (o EzsignbulksendsignermappingResponseV3) MarshalJSON() ([]byte, error) {
...
func (o EzsignbulksendsignermappingResponseV3) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignbulksendsignermappingResponseV3) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignbulksendsignermappingResponseV3 := _EzsignbulksendsignermappingResponseV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignbulksendsignermappingResponseV3)

	if err != nil {
		return err
	}

	*o = EzsignbulksendsignermappingResponseV3(varEzsignbulksendsignermappingResponseV3)

	return err
}

type NullableEzsignbulksendsignermappingResponseV3 struct {
	value *EzsignbulksendsignermappingResponseV3
	isSet bool
}

func (v NullableEzsignbulksendsignermappingResponseV3) Get() *EzsignbulksendsignermappingResponseV3 {
	return v.value
}

func (v *NullableEzsignbulksendsignermappingResponseV3) Set(val *EzsignbulksendsignermappingResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignbulksendsignermappingResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignbulksendsignermappingResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignbulksendsignermappingResponseV3(val *EzsignbulksendsignermappingResponseV3) *NullableEzsignbulksendsignermappingResponseV3 {
	return &NullableEzsignbulksendsignermappingResponseV3{value: val, isSet: true}
}

func (v NullableEzsignbulksendsignermappingResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignbulksendsignermappingResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
