...
// checks if the EzsigntemplatesignatureResponseCompoundV4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplatesignatureResponseCompoundV4{}

// EzsigntemplatesignatureResponseCompoundV4 A Ezsigntemplatesignature Object
type EzsigntemplatesignatureResponseCompoundV4 struct {
...
type _EzsigntemplatesignatureResponseCompoundV4 EzsigntemplatesignatureResponseCompoundV4
...
func NewEzsigntemplatesignatureResponseCompoundV4(pkiEzsigntemplatesignatureID int32, fkiEzsigntemplatedocumentID int32, fkiEzsigntemplatesignerID int32, iEzsigntemplatedocumentpagePagenumber int32, iEzsigntemplatesignatureStep int32, eEzsigntemplatesignatureType FieldEEzsigntemplatesignatureType) *EzsigntemplatesignatureResponseCompoundV4 {
	this := EzsigntemplatesignatureResponseCompoundV4{}
...
func (o EzsigntemplatesignatureResponseCompoundV4) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplatesignatureResponseCompoundV4) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplatesignatureResponseCompoundV4) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatesignatureResponseCompoundV4 := _EzsigntemplatesignatureResponseCompoundV4{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatesignatureResponseCompoundV4)

	if err != nil {
		return err
	}

	*o = EzsigntemplatesignatureResponseCompoundV4(varEzsigntemplatesignatureResponseCompoundV4)

	return err
}

type NullableEzsigntemplatesignatureResponseCompoundV4 struct {
	value *EzsigntemplatesignatureResponseCompoundV4
	isSet bool
}

func (v NullableEzsigntemplatesignatureResponseCompoundV4) Get() *EzsigntemplatesignatureResponseCompoundV4 {
	return v.value
}

func (v *NullableEzsigntemplatesignatureResponseCompoundV4) Set(val *EzsigntemplatesignatureResponseCompoundV4) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplatesignatureResponseCompoundV4) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplatesignatureResponseCompoundV4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplatesignatureResponseCompoundV4(val *EzsigntemplatesignatureResponseCompoundV4) *NullableEzsigntemplatesignatureResponseCompoundV4 {
	return &NullableEzsigntemplatesignatureResponseCompoundV4{value: val, isSet: true}
}

func (v NullableEzsigntemplatesignatureResponseCompoundV4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplatesignatureResponseCompoundV4) UnmarshalJSON(src []byte) error {
	v.isSet = true
