...
// EzsignfolderResponseAllOf struct for EzsignfolderResponseAllOf
type EzsignfolderResponseAllOf struct {
...
func NewEzsignfolderResponseAllOf(fkiEzsignfoldertypeID int32, fkiEzsigntsarequirementID int32, sEzsignfolderDescription string, tEzsignfolderNote string, eEzsignfolderSendreminderfrequency FieldEEzsignfolderSendreminderfrequency, pkiEzsignfolderID int32, dtEzsignfolderSentdate string, eEzsignfolderStep FieldEEzsignfolderStep, dtEzsignfolderClose string, objAudit CommonAudit) *EzsignfolderResponseAllOf {
	this := EzsignfolderResponseAllOf{}
...
func (o EzsignfolderResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableEzsignfolderResponseAllOf struct {
	value *EzsignfolderResponseAllOf
	isSet bool
}

func (v NullableEzsignfolderResponseAllOf) Get() *EzsignfolderResponseAllOf {
	return v.value
}

func (v *NullableEzsignfolderResponseAllOf) Set(val *EzsignfolderResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignfolderResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignfolderResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignfolderResponseAllOf(val *EzsignfolderResponseAllOf) *NullableEzsignfolderResponseAllOf {
	return &NullableEzsignfolderResponseAllOf{value: val, isSet: true}
}

func (v NullableEzsignfolderResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignfolderResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
