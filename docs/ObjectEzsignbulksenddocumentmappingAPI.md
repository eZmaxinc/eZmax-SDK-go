...
> CommonResponse EzsignbulksenddocumentmappingDeleteObjectV1(ctx, pkiEzsignbulksenddocumentmappingID).Execute()
...
func main() {
	...
	// response from `EzsignbulksenddocumentmappingDeleteObjectV1`: CommonResponse
