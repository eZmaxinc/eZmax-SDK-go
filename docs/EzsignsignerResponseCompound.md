...
`func NewEzsignsignerResponseCompound(objContact EzsignsignerResponseCompoundContact, fkiTaxassignmentID int32, eEzsignsignerLogintype string, ) *EzsignsignerResponseCompound`
...
`func (o *EzsignsignerResponseCompound) GetEEzsignsignerLogintype() string`
...
`func (o *EzsignsignerResponseCompound) GetEEzsignsignerLogintypeOk() (*string, bool)`
...
`func (o *EzsignsignerResponseCompound) SetEEzsignsignerLogintype(v string)`
...
`func (o *EzsignsignerResponseCompound) GetSEzsignsignerSecretanswer() string`
...
`func (o *EzsignsignerResponseCompound) GetSEzsignsignerSecretanswerOk() (*string, bool)`
...
`func (o *EzsignsignerResponseCompound) SetSEzsignsignerSecretanswer(v string)`

SetSEzsignsignerSecretanswer sets SEzsignsignerSecretanswer field to given value.

### HasSEzsignsignerSecretanswer

`func (o *EzsignsignerResponseCompound) HasSEzsignsignerSecretanswer() bool`
