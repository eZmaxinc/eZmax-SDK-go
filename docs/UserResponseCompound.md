...
`func (o *UserResponseCompound) GetFkiEzmaxpartnerID() int32`

GetFkiEzmaxpartnerID returns the FkiEzmaxpartnerID field if non-nil, zero value otherwise.

### GetFkiEzmaxpartnerIDOk

`func (o *UserResponseCompound) GetFkiEzmaxpartnerIDOk() (*int32, bool)`
...
`func (o *UserResponseCompound) SetFkiEzmaxpartnerID(v int32)`

SetFkiEzmaxpartnerID sets FkiEzmaxpartnerID field to given value.

### HasFkiEzmaxpartnerID

`func (o *UserResponseCompound) HasFkiEzmaxpartnerID() bool`
...
`func (o *UserResponseCompound) GetBUserSuspended() bool`

GetBUserSuspended returns the BUserSuspended field if non-nil, zero value otherwise.

### GetBUserSuspendedOk

`func (o *UserResponseCompound) GetBUserSuspendedOk() (*bool, bool)`
...
`func (o *UserResponseCompound) SetBUserSuspended(v bool)`

SetBUserSuspended sets BUserSuspended field to given value.

### HasBUserSuspended

`func (o *UserResponseCompound) HasBUserSuspended() bool`
...
`func (o *UserResponseCompound) GetBUserEzsigntemplaterolegrouping() bool`
...
`func (o *UserResponseCompound) GetBUserEzsigntemplaterolegroupingOk() (*bool, bool)`
...
`func (o *UserResponseCompound) SetBUserEzsigntemplaterolegrouping(v bool)`
...
`func (o *UserResponseCompound) HasBUserEzsigntemplaterolegrouping() bool`
