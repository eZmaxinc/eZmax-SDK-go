...
`func (o *BrandingRequestCompoundV2) GetFkiDomainID() int32`

GetFkiDomainID returns the FkiDomainID field if non-nil, zero value otherwise.

### GetFkiDomainIDOk

`func (o *BrandingRequestCompoundV2) GetFkiDomainIDOk() (*int32, bool)`
...
`func (o *BrandingRequestCompoundV2) SetFkiDomainID(v int32)`

SetFkiDomainID sets FkiDomainID field to given value.

### HasFkiDomainID

`func (o *BrandingRequestCompoundV2) HasFkiDomainID() bool`
