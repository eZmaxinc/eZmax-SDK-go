...
`func NewEzsigntemplatesignaturecustomdateResponse(pkiEzsigntemplatesignaturecustomdateID int32, iEzsigntemplatesignaturecustomdateX int32, iEzsigntemplatesignaturecustomdateY int32, sEzsigntemplatesignaturecustomdateFormat string, ) *EzsigntemplatesignaturecustomdateResponse`
