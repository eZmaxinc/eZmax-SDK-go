...
`func (o *EzsignsignatureRequestCompound) GetFkiPaymentgatewayID() int32`

GetFkiPaymentgatewayID returns the FkiPaymentgatewayID field if non-nil, zero value otherwise.

### GetFkiPaymentgatewayIDOk

`func (o *EzsignsignatureRequestCompound) GetFkiPaymentgatewayIDOk() (*int32, bool)`
...
`func (o *EzsignsignatureRequestCompound) SetFkiPaymentgatewayID(v int32)`

SetFkiPaymentgatewayID sets FkiPaymentgatewayID field to given value.

### HasFkiPaymentgatewayID

`func (o *EzsignsignatureRequestCompound) HasFkiPaymentgatewayID() bool`
...
`func (o *EzsignsignatureRequestCompound) SetBEzsignsignatureHandwritten(v bool)`
...
`func (o *EzsignsignatureRequestCompound) SetSEzsignsignatureDefaultvalue(v string)`
...
`func (o *EzsignsignatureRequestCompound) SetSEzsignsignatureTextvalidationcustommessage(v string)`
