...
> EzsigntemplatepackagesignerCreateObjectV2Response EzsigntemplatepackagesignerCreateObjectV2(ctx).EzsigntemplatepackagesignerCreateObjectV2Request(ezsigntemplatepackagesignerCreateObjectV2Request).Execute()
...
func main() {
	ezsigntemplatepackagesignerCreateObjectV2Request := *openapiclient.NewEzsigntemplatepackagesignerCreateObjectV2Request([]openapiclient.EzsigntemplatepackagesignerRequestCompoundV2{*openapiclient.NewEzsigntemplatepackagesignerRequestCompoundV2(int32(99), "Customer")}) // EzsigntemplatepackagesignerCreateObjectV2Request | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerCreateObjectV2(context.Background()).EzsigntemplatepackagesignerCreateObjectV2Request(ezsigntemplatepackagesignerCreateObjectV2Request).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerCreateObjectV2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `EzsigntemplatepackagesignerCreateObjectV2`: EzsigntemplatepackagesignerCreateObjectV2Response
	fmt.Fprintf(os.Stdout, "Response from `ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerCreateObjectV2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiEzsigntemplatepackagesignerCreateObjectV2Request struct via the builder pattern
...
> EzsigntemplatepackagesignerEditObjectV2Response EzsigntemplatepackagesignerEditObjectV2(ctx, pkiEzsigntemplatepackagesignerID).EzsigntemplatepackagesignerEditObjectV2Request(ezsigntemplatepackagesignerEditObjectV2Request).Execute()
...
func main() {
	pkiEzsigntemplatepackagesignerID := int32(56) // int32 | 
	ezsigntemplatepackagesignerEditObjectV2Request := *openapiclient.NewEzsigntemplatepackagesignerEditObjectV2Request(*openapiclient.NewEzsigntemplatepackagesignerRequestCompoundV2(int32(99), "Customer")) // EzsigntemplatepackagesignerEditObjectV2Request | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerEditObjectV2(context.Background(), pkiEzsigntemplatepackagesignerID).EzsigntemplatepackagesignerEditObjectV2Request(ezsigntemplatepackagesignerEditObjectV2Request).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerEditObjectV2``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `EzsigntemplatepackagesignerEditObjectV2`: EzsigntemplatepackagesignerEditObjectV2Response
	fmt.Fprintf(os.Stdout, "Response from `ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerEditObjectV2`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiEzsigntemplatepackagesignerEditObjectV2Request struct via the builder pattern
...
> EzsigntemplatepackagesignerGetObjectV3Response EzsigntemplatepackagesignerGetObjectV3(ctx, pkiEzsigntemplatepackagesignerID).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerGetObjectV3(context.Background(), pkiEzsigntemplatepackagesignerID).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerGetObjectV3``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `EzsigntemplatepackagesignerGetObjectV3`: EzsigntemplatepackagesignerGetObjectV3Response
	fmt.Fprintf(os.Stdout, "Response from `ObjectEzsigntemplatepackagesignerAPI.EzsigntemplatepackagesignerGetObjectV3`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiEzsigntemplatepackagesignerGetObjectV3Request struct via the builder pattern
