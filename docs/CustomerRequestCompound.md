...
`func (o *CustomerRequestCompound) GetSCustomerNote() string`

GetSCustomerNote returns the SCustomerNote field if non-nil, zero value otherwise.

### GetSCustomerNoteOk

`func (o *CustomerRequestCompound) GetSCustomerNoteOk() (*string, bool)`
...
`func (o *CustomerRequestCompound) SetSCustomerNote(v string)`

SetSCustomerNote sets SCustomerNote field to given value.

### HasSCustomerNote

`func (o *CustomerRequestCompound) HasSCustomerNote() bool`
