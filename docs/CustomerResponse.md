...
`func (o *CustomerResponse) GetSCustomerNote() string`

GetSCustomerNote returns the SCustomerNote field if non-nil, zero value otherwise.

### GetSCustomerNoteOk

`func (o *CustomerResponse) GetSCustomerNoteOk() (*string, bool)`
...
`func (o *CustomerResponse) SetSCustomerNote(v string)`

SetSCustomerNote sets SCustomerNote field to given value.

### HasSCustomerNote

`func (o *CustomerResponse) HasSCustomerNote() bool`
