...
// checks if the FranchiseofficeGetAutocompleteV2Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FranchiseofficeGetAutocompleteV2Response{}
...
type _FranchiseofficeGetAutocompleteV2Response FranchiseofficeGetAutocompleteV2Response
...
func (o *FranchiseofficeGetAutocompleteV2Response) GetMPayload() FranchiseofficeGetAutocompleteV2ResponseMPayload {
	if o == nil {
		var ret FranchiseofficeGetAutocompleteV2ResponseMPayload
		return ret
	}
...
func (o FranchiseofficeGetAutocompleteV2Response) MarshalJSON() ([]byte, error) {
...
func (o *FranchiseofficeGetAutocompleteV2Response) UnmarshalJSON(data []byte) (err error) {
	...
	varFranchiseofficeGetAutocompleteV2Response := _FranchiseofficeGetAutocompleteV2Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFranchiseofficeGetAutocompleteV2Response)

	if err != nil {
		return err
	}

	*o = FranchiseofficeGetAutocompleteV2Response(varFranchiseofficeGetAutocompleteV2Response)

	return err
}

type NullableFranchiseofficeGetAutocompleteV2Response struct {
	value *FranchiseofficeGetAutocompleteV2Response
	isSet bool
}

func (v NullableFranchiseofficeGetAutocompleteV2Response) Get() *FranchiseofficeGetAutocompleteV2Response {
	return v.value
}

func (v *NullableFranchiseofficeGetAutocompleteV2Response) Set(val *FranchiseofficeGetAutocompleteV2Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFranchiseofficeGetAutocompleteV2Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFranchiseofficeGetAutocompleteV2Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFranchiseofficeGetAutocompleteV2Response(val *FranchiseofficeGetAutocompleteV2Response) *NullableFranchiseofficeGetAutocompleteV2Response {
	return &NullableFranchiseofficeGetAutocompleteV2Response{value: val, isSet: true}
}

func (v NullableFranchiseofficeGetAutocompleteV2Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFranchiseofficeGetAutocompleteV2Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
