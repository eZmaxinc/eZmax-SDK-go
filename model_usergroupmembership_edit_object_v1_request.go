...
type _UsergroupmembershipEditObjectV1Request UsergroupmembershipEditObjectV1Request
...
func (o *UsergroupmembershipEditObjectV1Request) UnmarshalJSON(data []byte) (err error) {
	...
	varUsergroupmembershipEditObjectV1Request := _UsergroupmembershipEditObjectV1Request{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsergroupmembershipEditObjectV1Request)

	if err != nil {
		return err
	}

	*o = UsergroupmembershipEditObjectV1Request(varUsergroupmembershipEditObjectV1Request)
