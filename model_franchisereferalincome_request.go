...
type _FranchisereferalincomeRequest FranchisereferalincomeRequest
...
func (o *FranchisereferalincomeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varFranchisereferalincomeRequest := _FranchisereferalincomeRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFranchisereferalincomeRequest)

	if err != nil {
		return err
	}

	*o = FranchisereferalincomeRequest(varFranchisereferalincomeRequest)
