...
type ApiEzsigntemplateGetObjectV4Request struct {
	ctx context.Context
	ApiService *ObjectEzsigntemplateAPIService
	pkiEzsigntemplateID int32
}

func (r ApiEzsigntemplateGetObjectV4Request) Execute() (*EzsigntemplateGetObjectV4Response, *http.Response, error) {
	return r.ApiService.EzsigntemplateGetObjectV4Execute(r)
}

/*
EzsigntemplateGetObjectV4 Retrieve an existing Ezsigntemplate



 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiEzsigntemplateID
 @return ApiEzsigntemplateGetObjectV4Request
*/
func (a *ObjectEzsigntemplateAPIService) EzsigntemplateGetObjectV4(ctx context.Context, pkiEzsigntemplateID int32) ApiEzsigntemplateGetObjectV4Request {
	return ApiEzsigntemplateGetObjectV4Request{
		ApiService: a,
		ctx: ctx,
		pkiEzsigntemplateID: pkiEzsigntemplateID,
...
func (a *ObjectEzsigntemplateAPIService) EzsigntemplateGetObjectV4Execute(r ApiEzsigntemplateGetObjectV4Request) (*EzsigntemplateGetObjectV4Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EzsigntemplateGetObjectV4Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectEzsigntemplateAPIService.EzsigntemplateGetObjectV4")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/4/object/ezsigntemplate/{pkiEzsigntemplateID}"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiEzsigntemplateID"+"}", url.PathEscape(parameterValueToString(r.pkiEzsigntemplateID, "pkiEzsigntemplateID")), -1)
