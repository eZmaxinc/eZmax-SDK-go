...
type _UsergroupmembershipEditObjectV1Response UsergroupmembershipEditObjectV1Response
...
func (o *UsergroupmembershipEditObjectV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUsergroupmembershipEditObjectV1Response := _UsergroupmembershipEditObjectV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsergroupmembershipEditObjectV1Response)

	if err != nil {
		return err
	}

	*o = UsergroupmembershipEditObjectV1Response(varUsergroupmembershipEditObjectV1Response)
