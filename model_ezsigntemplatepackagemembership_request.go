...
type _EzsigntemplatepackagemembershipRequest EzsigntemplatepackagemembershipRequest
...
func (o *EzsigntemplatepackagemembershipRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepackagemembershipRequest := _EzsigntemplatepackagemembershipRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepackagemembershipRequest)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepackagemembershipRequest(varEzsigntemplatepackagemembershipRequest)
