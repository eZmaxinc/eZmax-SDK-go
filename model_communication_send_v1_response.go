...
// checks if the CommunicationSendV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommunicationSendV1Response{}
...
type CommunicationSendV1Response struct {
	...
	MPayload CommunicationCreateObjectV1ResponseMPayload `json:"mPayload"`
}

type _CommunicationSendV1Response CommunicationSendV1Response
...
func (o *CommunicationSendV1Response) GetMPayload() CommunicationCreateObjectV1ResponseMPayload {
	if o == nil {
		var ret CommunicationCreateObjectV1ResponseMPayload
		return ret
	}
...
func (o CommunicationSendV1Response) MarshalJSON() ([]byte, error) {
...
func (o *CommunicationSendV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCommunicationSendV1Response := _CommunicationSendV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommunicationSendV1Response)

	if err != nil {
		return err
	}

	*o = CommunicationSendV1Response(varCommunicationSendV1Response)

	return err
}

type NullableCommunicationSendV1Response struct {
	value *CommunicationSendV1Response
	isSet bool
}

func (v NullableCommunicationSendV1Response) Get() *CommunicationSendV1Response {
	return v.value
}

func (v *NullableCommunicationSendV1Response) Set(val *CommunicationSendV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCommunicationSendV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCommunicationSendV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommunicationSendV1Response(val *CommunicationSendV1Response) *NullableCommunicationSendV1Response {
	return &NullableCommunicationSendV1Response{value: val, isSet: true}
}

func (v NullableCommunicationSendV1Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommunicationSendV1Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
