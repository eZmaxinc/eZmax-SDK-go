...
func NewInscriptionnotauthenticatedGetCommunicationsendersV1Response(objDebugPayload CommonResponseObjDebugPayload, mPayload InscriptionnotauthenticatedGetCommunicationsendersV1ResponseMPayload) *InscriptionnotauthenticatedGetCommunicationsendersV1Response {
...
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) GetObjDebugPayload() CommonResponseObjDebugPayload {
	if o == nil {
...
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) GetObjDebugPayloadOk() (*CommonResponseObjDebugPayload, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) SetObjDebugPayload(v CommonResponseObjDebugPayload) {
	o.ObjDebugPayload = v
}

// GetObjDebug returns the ObjDebug field value if set, zero value otherwise.
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) GetObjDebug() CommonResponseObjDebug {
...
// and a boolean to check if the value has been set.
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) GetObjDebugOk() (*CommonResponseObjDebug, bool) {
	if o == nil || IsNil(o.ObjDebug) {
		return nil, false
	}
...
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) HasObjDebug() bool {
	if o != nil && !IsNil(o.ObjDebug) {
		return true
	}
...
func (o *InscriptionnotauthenticatedGetCommunicationsendersV1Response) SetObjDebug(v CommonResponseObjDebug) {
	o.ObjDebug = &v
}
