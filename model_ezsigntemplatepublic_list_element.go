...
// checks if the EzsigntemplatepublicListElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplatepublicListElement{}

// EzsigntemplatepublicListElement A Ezsigntemplatepublic List Element
type EzsigntemplatepublicListElement struct {
...
type _EzsigntemplatepublicListElement EzsigntemplatepublicListElement
...
func NewEzsigntemplatepublicListElement(pkiEzsigntemplatepublicID int32, fkiEzsignfoldertypeID int32, sEzsignfoldertypeNameX string, fkiUserlogintypeID int32, sEzsigntemplatepublicDescription string, bEzsigntemplatepublicIsactive bool, tEzsigntemplatepublicNote string, eEzsigntemplatepublicLimittype FieldEEzsigntemplatepublicLimittype, iEzsigntemplatepublicLimit int32, iEzsigntemplatepublicLimitexceeded int32, dtEzsigntemplatepublicLimitexceededsince string, iEzsignfolder int32, iEzsigndocument int32, sEzsigntemplatepublicEzsigntemplatedescription string) *EzsigntemplatepublicListElement {
	this := EzsigntemplatepublicListElement{}
...
func (o EzsigntemplatepublicListElement) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplatepublicListElement) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplatepublicListElement) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepublicListElement := _EzsigntemplatepublicListElement{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepublicListElement)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepublicListElement(varEzsigntemplatepublicListElement)

	return err
}

type NullableEzsigntemplatepublicListElement struct {
	value *EzsigntemplatepublicListElement
	isSet bool
}

func (v NullableEzsigntemplatepublicListElement) Get() *EzsigntemplatepublicListElement {
	return v.value
}

func (v *NullableEzsigntemplatepublicListElement) Set(val *EzsigntemplatepublicListElement) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplatepublicListElement) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplatepublicListElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplatepublicListElement(val *EzsigntemplatepublicListElement) *NullableEzsigntemplatepublicListElement {
	return &NullableEzsigntemplatepublicListElement{value: val, isSet: true}
}

func (v NullableEzsigntemplatepublicListElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplatepublicListElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
