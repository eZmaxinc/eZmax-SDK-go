...
type _EzsignpageResponse EzsignpageResponse
...
func (o *EzsignpageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignpageResponse := _EzsignpageResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignpageResponse)

	if err != nil {
		return err
	}

	*o = EzsignpageResponse(varEzsignpageResponse)
