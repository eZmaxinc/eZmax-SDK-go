...
type _PhoneRequestCompound PhoneRequestCompound
...
func (o *PhoneRequestCompound) UnmarshalJSON(data []byte) (err error) {
	...
	varPhoneRequestCompound := _PhoneRequestCompound{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhoneRequestCompound)

	if err != nil {
		return err
	}

	*o = PhoneRequestCompound(varPhoneRequestCompound)
