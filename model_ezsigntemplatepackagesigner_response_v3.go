...
// checks if the EzsigntemplatepackagesignerResponseV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplatepackagesignerResponseV3{}

// EzsigntemplatepackagesignerResponseV3 A Ezsigntemplatepackagesigner Object
type EzsigntemplatepackagesignerResponseV3 struct {
...
type _EzsigntemplatepackagesignerResponseV3 EzsigntemplatepackagesignerResponseV3
...
func NewEzsigntemplatepackagesignerResponseV3(pkiEzsigntemplatepackagesignerID int32, fkiEzsigntemplatepackageID int32, sEzsigntemplatepackagesignerDescription string) *EzsigntemplatepackagesignerResponseV3 {
	this := EzsigntemplatepackagesignerResponseV3{}
...
func (o EzsigntemplatepackagesignerResponseV3) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplatepackagesignerResponseV3) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplatepackagesignerResponseV3) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatepackagesignerResponseV3 := _EzsigntemplatepackagesignerResponseV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatepackagesignerResponseV3)

	if err != nil {
		return err
	}

	*o = EzsigntemplatepackagesignerResponseV3(varEzsigntemplatepackagesignerResponseV3)

	return err
}

type NullableEzsigntemplatepackagesignerResponseV3 struct {
	value *EzsigntemplatepackagesignerResponseV3
	isSet bool
}

func (v NullableEzsigntemplatepackagesignerResponseV3) Get() *EzsigntemplatepackagesignerResponseV3 {
	return v.value
}

func (v *NullableEzsigntemplatepackagesignerResponseV3) Set(val *EzsigntemplatepackagesignerResponseV3) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplatepackagesignerResponseV3) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplatepackagesignerResponseV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplatepackagesignerResponseV3(val *EzsigntemplatepackagesignerResponseV3) *NullableEzsigntemplatepackagesignerResponseV3 {
	return &NullableEzsigntemplatepackagesignerResponseV3{value: val, isSet: true}
}

func (v NullableEzsigntemplatepackagesignerResponseV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplatepackagesignerResponseV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
