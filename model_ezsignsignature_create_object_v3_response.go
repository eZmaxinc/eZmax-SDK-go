...
// checks if the EzsignsignatureCreateObjectV3Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignsignatureCreateObjectV3Response{}
...
type _EzsignsignatureCreateObjectV3Response EzsignsignatureCreateObjectV3Response
...
func (o *EzsignsignatureCreateObjectV3Response) GetMPayload() EzsignsignatureCreateObjectV3ResponseMPayload {
	if o == nil {
		var ret EzsignsignatureCreateObjectV3ResponseMPayload
		return ret
	}
...
func (o EzsignsignatureCreateObjectV3Response) MarshalJSON() ([]byte, error) {
...
func (o *EzsignsignatureCreateObjectV3Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignsignatureCreateObjectV3Response := _EzsignsignatureCreateObjectV3Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignsignatureCreateObjectV3Response)

	if err != nil {
		return err
	}

	*o = EzsignsignatureCreateObjectV3Response(varEzsignsignatureCreateObjectV3Response)

	return err
}

type NullableEzsignsignatureCreateObjectV3Response struct {
	value *EzsignsignatureCreateObjectV3Response
	isSet bool
}

func (v NullableEzsignsignatureCreateObjectV3Response) Get() *EzsignsignatureCreateObjectV3Response {
	return v.value
}

func (v *NullableEzsignsignatureCreateObjectV3Response) Set(val *EzsignsignatureCreateObjectV3Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignsignatureCreateObjectV3Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignsignatureCreateObjectV3Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignsignatureCreateObjectV3Response(val *EzsignsignatureCreateObjectV3Response) *NullableEzsignsignatureCreateObjectV3Response {
	return &NullableEzsignsignatureCreateObjectV3Response{value: val, isSet: true}
}

func (v NullableEzsignsignatureCreateObjectV3Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignsignatureCreateObjectV3Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
