...
type _CommonGetListV1ResponseMPayload CommonGetListV1ResponseMPayload
...
func (o *CommonGetListV1ResponseMPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonGetListV1ResponseMPayload := _CommonGetListV1ResponseMPayload{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonGetListV1ResponseMPayload)

	if err != nil {
		return err
	}

	*o = CommonGetListV1ResponseMPayload(varCommonGetListV1ResponseMPayload)
