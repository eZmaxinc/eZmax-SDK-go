...
// checks if the EzsignsignatureCreateObjectV1Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignsignatureCreateObjectV1Response{}

// EzsignsignatureCreateObjectV1Response Response for POST /1/object/ezsignsignature
type EzsignsignatureCreateObjectV1Response struct {
	CommonResponse
	MPayload EzsignsignatureCreateObjectV1ResponseMPayload `json:"mPayload"`
}

type _EzsignsignatureCreateObjectV1Response EzsignsignatureCreateObjectV1Response
...
func NewEzsignsignatureCreateObjectV1Response(mPayload EzsignsignatureCreateObjectV1ResponseMPayload, objDebugPayload CommonResponseObjDebugPayload) *EzsignsignatureCreateObjectV1Response {
...
func (o EzsignsignatureCreateObjectV1Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["mPayload"] = o.MPayload
	return toSerialize, nil
}

func (o *EzsignsignatureCreateObjectV1Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignsignatureCreateObjectV1Response := _EzsignsignatureCreateObjectV1Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignsignatureCreateObjectV1Response)

	if err != nil {
		return err
	}

	*o = EzsignsignatureCreateObjectV1Response(varEzsignsignatureCreateObjectV1Response)
