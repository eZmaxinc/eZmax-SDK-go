...
type ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request struct {
	ctx context.Context
	ApiService *ObjectEzsignfoldersignerassociationAPIService
	pkiEzsignfoldersignerassociationID int32
...
func (r ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request) EzsignfoldersignerassociationCreateEmbeddedUrlV2Request(ezsignfoldersignerassociationCreateEmbeddedUrlV2Request EzsignfoldersignerassociationCreateEmbeddedUrlV2Request) ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request {
	r.ezsignfoldersignerassociationCreateEmbeddedUrlV2Request = &ezsignfoldersignerassociationCreateEmbeddedUrlV2Request
	return r
}

func (r ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request) Execute() (*EzsignfoldersignerassociationCreateEmbeddedUrlV2Response, *http.Response, error) {
	return r.ApiService.EzsignfoldersignerassociationCreateEmbeddedUrlV2Execute(r)
}

/*
EzsignfoldersignerassociationCreateEmbeddedUrlV2 Creates an Url to allow embedded signing
...
If the signing page is embedded in an `iframe`, the application sends events to the parent window via `window.postMessage`.
...
```json
{
  "source": "ezsign",
  "type": "eEzsignEvent",
  "payload": "CompletedEzsignfolder"
}
```

* **source**: Always `'ezsign'`.
* **type**: Always `'eEzsignEvent'`.
* **payload**: Corresponds to the **eEzsignEvent** values listed in the table above (e.g., `SessionTimeout`, `CompletedStep`, etc.).
...
window.addEventListener('message', (event) => {
    ...
    if (source === 'ezsign' && type === 'eEzsignEvent') {
...
```
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiEzsignfoldersignerassociationID
 @return ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request
*/
func (a *ObjectEzsignfoldersignerassociationAPIService) EzsignfoldersignerassociationCreateEmbeddedUrlV2(ctx context.Context, pkiEzsignfoldersignerassociationID int32) ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request {
	return ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request{
		ApiService: a,
		ctx: ctx,
		pkiEzsignfoldersignerassociationID: pkiEzsignfoldersignerassociationID,
...
func (a *ObjectEzsignfoldersignerassociationAPIService) EzsignfoldersignerassociationCreateEmbeddedUrlV2Execute(r ApiEzsignfoldersignerassociationCreateEmbeddedUrlV2Request) (*EzsignfoldersignerassociationCreateEmbeddedUrlV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EzsignfoldersignerassociationCreateEmbeddedUrlV2Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ObjectEzsignfoldersignerassociationAPIService.EzsignfoldersignerassociationCreateEmbeddedUrlV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/createEmbeddedUrl"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiEzsignfoldersignerassociationID"+"}", url.PathEscape(parameterValueToString(r.pkiEzsignfoldersignerassociationID, "pkiEzsignfoldersignerassociationID")), -1)
	...
	if r.ezsignfoldersignerassociationCreateEmbeddedUrlV2Request == nil {
		return localVarReturnValue, nil, reportError("ezsignfoldersignerassociationCreateEmbeddedUrlV2Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.ezsignfoldersignerassociationCreateEmbeddedUrlV2Request
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Authorization"]; ok {
...
type ApiEzsignfoldersignerassociationReassignV1Request struct {
	ctx context.Context
	ApiService *ObjectEzsignfoldersignerassociationAPIService
	pkiEzsignfoldersignerassociationID int32
...
func (r ApiEzsignfoldersignerassociationReassignV1Request) EzsignfoldersignerassociationReassignV1Request(ezsignfoldersignerassociationReassignV1Request EzsignfoldersignerassociationReassignV1Request) ApiEzsignfoldersignerassociationReassignV1Request {
	r.ezsignfoldersignerassociationReassignV1Request = &ezsignfoldersignerassociationReassignV1Request
	return r
}
...
/*
EzsignfoldersignerassociationReassignV1 Reassign remaining unsigned signatures and forms

Reassign remaining unsigned signatures and forms

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param pkiEzsignfoldersignerassociationID
 @return ApiEzsignfoldersignerassociationReassignV1Request
*/
func (a *ObjectEzsignfoldersignerassociationAPIService) EzsignfoldersignerassociationReassignV1(ctx context.Context, pkiEzsignfoldersignerassociationID int32) ApiEzsignfoldersignerassociationReassignV1Request {
	return ApiEzsignfoldersignerassociationReassignV1Request{
		ApiService: a,
		ctx: ctx,
		pkiEzsignfoldersignerassociationID: pkiEzsignfoldersignerassociationID,
...
func (a *ObjectEzsignfoldersignerassociationAPIService) EzsignfoldersignerassociationReassignV1Execute(r ApiEzsignfoldersignerassociationReassignV1Request) (*EzsignfoldersignerassociationReassignV1Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/reassign"
	localVarPath = strings.Replace(localVarPath, "{"+"pkiEzsignfoldersignerassociationID"+"}", url.PathEscape(parameterValueToString(r.pkiEzsignfoldersignerassociationID, "pkiEzsignfoldersignerassociationID")), -1)
	...
	if r.ezsignfoldersignerassociationReassignV1Request == nil {
		return localVarReturnValue, nil, reportError("ezsignfoldersignerassociationReassignV1Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.ezsignfoldersignerassociationReassignV1Request
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Authorization"]; ok {
