...
func NewListGetListpresentationV1Response(mPayload ListGetListpresentationV1ResponseMPayload) *ListGetListpresentationV1Response {
	this := ListGetListpresentationV1Response{}
...
type NullableListGetListpresentationV1Response struct {
	value *ListGetListpresentationV1Response
	isSet bool
}

func (v NullableListGetListpresentationV1Response) Get() *ListGetListpresentationV1Response {
	return v.value
}

func (v *NullableListGetListpresentationV1Response) Set(val *ListGetListpresentationV1Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListGetListpresentationV1Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListGetListpresentationV1Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListGetListpresentationV1Response(val *ListGetListpresentationV1Response) *NullableListGetListpresentationV1Response {
	return &NullableListGetListpresentationV1Response{value: val, isSet: true}
}

func (v NullableListGetListpresentationV1Response) MarshalJSON() ([]byte, error) {
