...
type _CustomCommunicationListElementResponse CustomCommunicationListElementResponse
...
func (o *CustomCommunicationListElementResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomCommunicationListElementResponse := _CustomCommunicationListElementResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomCommunicationListElementResponse)

	if err != nil {
		return err
	}

	*o = CustomCommunicationListElementResponse(varCustomCommunicationListElementResponse)
