...
// checks if the EzsigntemplatesignerRequestCompoundV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsigntemplatesignerRequestCompoundV2{}

// EzsigntemplatesignerRequestCompoundV2 A Ezsigntemplatesigner Object and children
type EzsigntemplatesignerRequestCompoundV2 struct {
...
type _EzsigntemplatesignerRequestCompoundV2 EzsigntemplatesignerRequestCompoundV2
...
func NewEzsigntemplatesignerRequestCompoundV2(fkiEzsigntemplateID int32, sEzsigntemplatesignerDescription string) *EzsigntemplatesignerRequestCompoundV2 {
	this := EzsigntemplatesignerRequestCompoundV2{}
...
func (o EzsigntemplatesignerRequestCompoundV2) MarshalJSON() ([]byte, error) {
...
func (o EzsigntemplatesignerRequestCompoundV2) ToMap() (map[string]interface{}, error) {
...
func (o *EzsigntemplatesignerRequestCompoundV2) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsigntemplatesignerRequestCompoundV2 := _EzsigntemplatesignerRequestCompoundV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsigntemplatesignerRequestCompoundV2)

	if err != nil {
		return err
	}

	*o = EzsigntemplatesignerRequestCompoundV2(varEzsigntemplatesignerRequestCompoundV2)

	return err
}

type NullableEzsigntemplatesignerRequestCompoundV2 struct {
	value *EzsigntemplatesignerRequestCompoundV2
	isSet bool
}

func (v NullableEzsigntemplatesignerRequestCompoundV2) Get() *EzsigntemplatesignerRequestCompoundV2 {
	return v.value
}

func (v *NullableEzsigntemplatesignerRequestCompoundV2) Set(val *EzsigntemplatesignerRequestCompoundV2) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsigntemplatesignerRequestCompoundV2) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsigntemplatesignerRequestCompoundV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsigntemplatesignerRequestCompoundV2(val *EzsigntemplatesignerRequestCompoundV2) *NullableEzsigntemplatesignerRequestCompoundV2 {
	return &NullableEzsigntemplatesignerRequestCompoundV2{value: val, isSet: true}
}

func (v NullableEzsigntemplatesignerRequestCompoundV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsigntemplatesignerRequestCompoundV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
