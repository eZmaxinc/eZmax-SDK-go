...
type _BrandingRequestCompound BrandingRequestCompound
...
func (o *BrandingRequestCompound) UnmarshalJSON(data []byte) (err error) {
	...
	varBrandingRequestCompound := _BrandingRequestCompound{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBrandingRequestCompound)

	if err != nil {
		return err
	}

	*o = BrandingRequestCompound(varBrandingRequestCompound)
