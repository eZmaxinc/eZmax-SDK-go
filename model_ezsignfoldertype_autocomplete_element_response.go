...
type _EzsignfoldertypeAutocompleteElementResponse EzsignfoldertypeAutocompleteElementResponse
...
func (o *EzsignfoldertypeAutocompleteElementResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfoldertypeAutocompleteElementResponse := _EzsignfoldertypeAutocompleteElementResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfoldertypeAutocompleteElementResponse)

	if err != nil {
		return err
	}

	*o = EzsignfoldertypeAutocompleteElementResponse(varEzsignfoldertypeAutocompleteElementResponse)
