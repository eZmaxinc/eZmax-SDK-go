...
// checks if the EzsignfoldertypeRequestV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EzsignfoldertypeRequestV3{}

// EzsignfoldertypeRequestV3 A Ezsignfoldertype Object
type EzsignfoldertypeRequestV3 struct {
...
type _EzsignfoldertypeRequestV3 EzsignfoldertypeRequestV3
...
func (o EzsignfoldertypeRequestV3) MarshalJSON() ([]byte, error) {
...
func (o EzsignfoldertypeRequestV3) ToMap() (map[string]interface{}, error) {
...
func (o *EzsignfoldertypeRequestV3) UnmarshalJSON(data []byte) (err error) {
	...
	varEzsignfoldertypeRequestV3 := _EzsignfoldertypeRequestV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEzsignfoldertypeRequestV3)

	if err != nil {
		return err
	}

	*o = EzsignfoldertypeRequestV3(varEzsignfoldertypeRequestV3)

	return err
}

type NullableEzsignfoldertypeRequestV3 struct {
	value *EzsignfoldertypeRequestV3
	isSet bool
}

func (v NullableEzsignfoldertypeRequestV3) Get() *EzsignfoldertypeRequestV3 {
	return v.value
}

func (v *NullableEzsignfoldertypeRequestV3) Set(val *EzsignfoldertypeRequestV3) {
	v.value = val
	v.isSet = true
}

func (v NullableEzsignfoldertypeRequestV3) IsSet() bool {
	return v.isSet
}

func (v *NullableEzsignfoldertypeRequestV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEzsignfoldertypeRequestV3(val *EzsignfoldertypeRequestV3) *NullableEzsignfoldertypeRequestV3 {
	return &NullableEzsignfoldertypeRequestV3{value: val, isSet: true}
}

func (v NullableEzsignfoldertypeRequestV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEzsignfoldertypeRequestV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
