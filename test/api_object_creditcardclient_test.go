...
func Test_eZmaxApi_ObjectCreditcardclientAPIService(t *testing.T) {
	...
	t.Run("Test ObjectCreditcardclientAPIService CreditcardclientPatchObjectV1", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var pkiCreditcardclientID int32

		resp, httpRes, err := apiClient.ObjectCreditcardclientAPI.CreditcardclientPatchObjectV1(context.Background(), pkiCreditcardclientID).Execute()
